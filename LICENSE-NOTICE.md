...
- Use the hosted tool at https://arling.sk/supabase-redirect-doctor/
  freely, for any purpose, personal or commercial, at no cost.
- Read the source of `index.html` / `doctor-web.js` to understand or
  verify what it does client-side (it's static files: view source is
  the whole codebase).
...
- Use the "Supabase Redirect Doctor" name, the ARLing s. r. o. name,
  or associated branding for your own project.
